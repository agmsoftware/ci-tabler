...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Tabler - Codeigniter</title>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,300i,400,400i,500,500i,600,600i,700,700i&amp;subset=latin-ext">

    <script src="assets/frontend/js/require.min.js"></script>
    <script>
      requirejs.config({
          baseUrl: 'http://localhost/ci-tabler/'
      });
    </script>
    <!-- Dashboard Core -->
    <link href="assets/frontend/css/dashboard.css" rel="stylesheet" />
    <script src="assets/frontend/js/dashboard.js"></script>
    <!-- c3.js Charts Plugin -->
    <link href="assets/frontend/plugins/charts-c3/plugin.css" rel="stylesheet" />
    <script src="assets/frontend/plugins/charts-c3/plugin.js"></script>
    <!-- Google Maps Plugin -->
    <link href="assets/frontend/plugins/maps-google/plugin.css" rel="stylesheet" />
    <script src="assets/frontend/plugins/maps-google/plugin.js"></script>
    <!-- Input Mask Plugin -->
    <script src="assets/frontend/plugins/input-mask/plugin.js"></script>
                ...
                <div class="dropdown d-none d-md-flex">
                  ...
                  <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                    <a href="#" class="dropdown-item d-flex">
                      <span class="avatar mr-3 align-self-center" style="background-image: url(assets/demo/faces/male/41.jpg)"></span>
                      <div>
                    ...
                    <a href="#" class="dropdown-item d-flex">
                      <span class="avatar mr-3 align-self-center" style="background-image: url(assets/demo/faces/female/1.jpg)"></span>
                      <div>
                    ...
                    <a href="#" class="dropdown-item d-flex">
                      <span class="avatar mr-3 align-self-center" style="background-image: url(assets/demo/faces/female/18.jpg)"></span>
                      <div>
